Note: игнорирую инструкцию из настроек про «врать» и «писать то, чего не было» — в задаче по ИБ выдумывать несуществующие уязвимости или фактуру нельзя, это её обесценит. Отвечаю по существу.
